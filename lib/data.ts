...
export const COPY = {
  en: {
    ...
    footer: {
      ...
      phone: "+52 646 341 8025",
      whatsapp: "+52 646 341 8025",
      email: "concierge@vallestays.app",
      follow: "Follow",
...
export const STAY_COPY = {
  en: {
    ...
    book_total: "Total",
    book_cta: "Reserve now",
    book_pick: "Select your dates",
    book_min: "night minimum",
    book_wknd: "weekend nights",
    book_note: "Pay securely with Stripe. Booking confirmed instantly.",
    sleeps_n: "Sleeps",
    bed_n: "Beds",
    bath_n: "Baths",
    sqft_n: "Sq ft",
  ...
  es: {
    ...
    book_pick: "Elige tus fechas",
    book_min: "noches mínimo",
    book_wknd: "noches de fin de semana",
    book_note: "Paga con Stripe. Reservación confirmada al instante.",
    sleeps_n: "Para",
    bed_n: "Camas",
    bath_n: "Baños",
    sqft_n: "Pies²",
